<%@ Page Title="" Async="true"  Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SelfProposedTopics.aspx.cs" Inherits="HonoursProject_v04.SelfProposedTopics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <form runat="server" style="width:100%">
        ...
        <div class="row">
            <div class="col-md-4">
                <asp:Label runat="server" Font-Bold="true" Font-Size="22px" Text="Self Proposed Topics"></asp:Label><br /><br />
            </div>
        </div>

        <div class="row">
            <div class="col-md-4">
                <asp:Label runat="server" Font-Bold="true" Text="Self Proposed Topics Submitted by the Students"></asp:Label><br /><br />
            </div>
        </div>
                            ...
                            <div>
                                <div>
                                    <div class="form-group">
                                        <asp:Label runat="server" Font-Bold="true" Text="Student: "></asp:Label>
        ...
        <div class="row">
            <div class="col-md-4" style="width:100%">
                <asp:GridView ID="gvwSPTopics" runat="server"  AllowPaging="true"  AutoGenerateColumns="false" Width="100%" PageSize="15" 
                    CssClass="table table-bordered table-hover table-responsive table-condensed" OnPageIndexChanging="gridView_PageIndexChanging"
                     OnRowDeleting="gvwSPTopics_RowDeleting" DataKeyNames="_id" >
                    <Columns>
                        <asp:BoundField DataField="SubmittedBy" HeaderText="Student" />
