    ...
    <form runat="server" style="width:100%">
        ...
        <div class="row">
            <div class="col-md-4" style="width:100%">
                <asp:GridView ID="gvwTopics" runat="server"  AllowPaging="true"  AutoGenerateColumns="false" Width="100%" PageSize="15" 
                    CssClass="table table-bordered table-hover table-responsive table-condensed" OnPageIndexChanging="gridView_PageIndexChanging"
                     OnRowDeleting="gvwTopics_RowDeleting" DataKeyNames="_id" OnRowDataBound="gvwTopics_RowDataBound" >
                    <Columns>
